...
def my_collate_fn(batch):
    ...
    for sample in batch:
        ...
        targets.append(torch.FloatTensor(sample[1]))#sample[1] = anno
...
if __name__ == '__main__':
    ...
    val_dataloader = data.DataLoader(val_dataset, batch_size, shuffle=True, collate_fn = my_collate_fn)
    dataloader_dict = {
    ...
    print(images.size())
    print(len(targets))
    print(targets[0].size())#xmin , y min , x max, y max,labels
